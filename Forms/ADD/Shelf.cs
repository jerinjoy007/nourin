...
{
    public partial class Shelf : Gramboo.Controls.GrbForm
    {
        ...
        {
            Table t = new Table(project.Classes.Common.DbName, "ITM", "Shelf");
            t.PrimaryKeys.Add("ShelfId");
        ...
        private void PopulateGrid()
        {
            ...
            dgvList.HiddenDataFields = new List<string>() { "ShelfId", "[Shelf Code]", "[Shelf Name]", "Counter_id", "Created_by", "Last_modified_by", "ItemId", "Company_id", "Branch_id" };
            dgvList.Fill(new Table(project.Classes.Common.DbName, "ITM", "VShelf", true));
        }
